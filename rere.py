...
def train(
    ...
    category_dict = {"Yelp":"restaurants", "Industrial_and_Scientific": "industrial and scientific items", "Toys_and_Games": "toys and games"}
    print(category)
    ...
    training_args = GRPOConfig(output_dir=output_dir,
                                ...
                                gradient_accumulation_steps=gradient_accumulation_steps,  # 总共 128 个样本后更新一次参数
