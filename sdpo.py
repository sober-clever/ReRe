...
from data import D3Dataset, DPODataset
...
def train(
    ...
    train_data = DPODataset(train_file=train_file, info_file=info_file, tokenizer=tokenizer, neg_num=neg_num, max_len=cutoff_len, seed=seed, category=category)
